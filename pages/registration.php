...
<body>
    ...
    <div class="radio-inputs">
        ...
        <label class="radio">
            <input type="radio" name="formOption" value="guardian-relation">
            <span class="name">Guardian Relation Creation</span>
        </label>
        <label class="radio">
    ...
    <div class="guardian-relation">
        <form action="/forms/addguardian-relation.php" id="guardian-relation" method="POST" class="m-5">
            <div class="mb-3">
